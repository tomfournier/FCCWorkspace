...
class RDFanalysis():
    ...
    def analysers(df):
        ...
        df2 = df2.Define("acolinearity", "if(zll_Leptons_acolinearity.size()>0) return zll_acolinearity.at(0); else return -std::numeric_limits<float>::max()") 
        df2 = df2.Define("acoplanarity", "if(zll_Leptons_acoplanarity.size()>0) return zll_acoplanarity.at(0); else return -std::numeric_limits<float>::max()") 
        ...
        ### Define MVA 
        ##############
        df2 = df2.Define("MVAVec", ROOT.computeModel1, (
                                                #leptons
                                                "leading_p",
                                                "leading_theta",
                                                "subleading_p",
        ...
        df2 = df2.Define("zbuilder_result_scaleup", "HiggsTools::resonanceBuilder_mass_recoil(91.2, 125, 0.4, 240, false)(leps_scaleup, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
        df2 = df2.Define("zll_scaleup", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_scaleup[0]}")
        df2 = df2.Define("zll_recoil_scaleup", "FCCAnalyses::ReconstructedParticle::recoilBuilder(240)(zll_scaleup)")
        ...
        df2 = df2.Define("acolinearity_scaleup", "if(zll_Leptons_acolinearity_scaleup.size()>0) return zll_Leptons_acolinearity_scaleup.at(0); else return -std::numeric_limits<float>::max()") 
        ...
        df2 = df2.Define("MVAVec_scaleup", ROOT.computeModel1, (
                                                # leptons
                                                "leading_p_scaleup",
        ...
        df2 = df2.Define("zbuilder_result_scaledw", "HiggsTools::resonanceBuilder_mass_recoil(91.2, 125, 0.4, 240, false)(leps_scaledw, MCRecoAssociations0, MCRecoAssociations1, ReconstructedParticles, Particle, Particle0, Particle1)")
        df2 = df2.Define("zll_scaledw", "ROOT::VecOps::RVec<edm4hep::ReconstructedParticleData>{zbuilder_result_scaledw[0]}")
        df2 = df2.Define("zll_recoil_scaledw", "FCCAnalyses::ReconstructedParticle::recoilBuilder(240)(zll_scaledw)")
        ...
        df2 = df2.Define("zll_acolinearity_scaledw", "HiggsTools::acolinearity(sorted_zll_leptons_scaledw)")
        df2 = df2.Define("zll_acoplanarity_scaledw", "HiggsTools::acoplanarity(sorted_zll_leptons_scaledw)") 
        ...
        df2 = df2.Define("MVAVec_scaledw", ROOT.computeModel1, (
                                                # leptons
                                                "leading_p_scaledw",
        ...
        # sqrt uncertainty
        df2 = df2.Define("zll_recoil_sqrtsup", "FCCAnalyses::ReconstructedParticle::recoilBuilder(240.002)(zll)")
        df2 = df2.Define("zll_recoil_sqrtsdw", "FCCAnalyses::ReconstructedParticle::recoilBuilder(239.998)(zll)")
