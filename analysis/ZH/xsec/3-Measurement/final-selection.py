...
from userConfig import loc, get_loc, event, ecm, lumi, param, frac, nb

from package.config import z_decays, H_decays, vars
...
# Define BDT score trained with cuts from sel_BDT
sel_BDT = 'Baseline'
loc_BDT = get_loc(loc.BDT, cat, ecm, sel_BDT)
defineList, bdt_cut = def_bdt(vars, sel_BDT)

Baseline_Cut = 'zll_m > 86 && zll_m < 96 && zll_p > 20 && zll_p < 70'
vis, inv = Baseline_Cut + ' && visibleEnergy > 100', Baseline_Cut + ' && visibleEnergy < 100'
cutList = { 
    # 'sel0':              'return true;',
    ...
    'Baseline_tight':    'zll_m > 86 && zll_m < 96 && zll_p > 20 && zll_p < 58'
}
